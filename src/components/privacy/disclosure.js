        ...
        <>
            ...
            <ul>
                ...
                <li>
                    ...
                    With your consent, or with an opportunity for you to withdraw consent, we may share your information with third parties
                    for marketing purposes, as permitted by law.
                </li>
                <li>
                    <b>Interactions with Other Users</b>:

                    If you interact with other users on our website, those users may see your name, profile photo, and descriptions
                    of your activity, including liking posts and following blogs.
                </li>
                <li>
                    <b>Online Postings</b>:

                    When you post comments, contributions or other content on our website, your posts may be viewed by all users and
                    may be publicly distributed outside the website in perpetuity.
                </li>
                <li>
                    ...
                    information about your visits to our website and other websites that are contained in web cookies in order to provide
                ...
                <li>
                    ...
                    Affiliates include our parent company and any subsidiaries, joint venture partners or other companies that we control or that are
            ...
            <p>
                ...
                manage or control third-party solicitations.  <b>If you no longer wish to receive correspondence, emails or other communications from
                third parties, you are responsible for contacting the third party directly.</b>
            </p>
        </>
    );
};
